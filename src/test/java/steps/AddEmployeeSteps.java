...
public class AddEmployeeSteps extends CommonMethods {
    ...
    public void user_enters_firstname_middlename_and_lastname() {
       ...
       sendText(addEmployeePage.firstNameField, "Homer");
       sendText(addEmployeePage.middleNameField, "Homie");
       sendText(addEmployeePage.lastNameField, "Simpson");
    }
    ...
    public void userProvidesMultipleEmployeeDataAndVerifiesTheyAreNeeded(DataTable dataTable) throws InterruptedException {
        ...
        for (Map<String,String>  employee:employeeNames) {
            ...
            //HW - verification of adding an employee
            click(employeeSearchPage.addEmployeeOption);
